                        ...
                        <form role="form" method="post" action="{{ route('posts.update', ['post'=>$post->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tags[]" id="tags" class="select2 select2-hidden-accessible"
                                        multiple="" data-placeholder="Выбор тегов" style="width: 100%;"
                                ...
                                <div class="form-group">
                                    ...
                                    <div><img src="{{ $post->getImage() }}" alt="" class="img-thumbnail mt-3" width="200"></div>
                                </div>
                            </div>
